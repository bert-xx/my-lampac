(function() {
  ...
  function startPlugin() {
    ...
    Lampa.Lang.add({
      ...
      lampac_video: { ru: 'Видео', uk: 'Відео', en: 'Video' },
      lampac_no_watch_history: { ru: 'Нет истории просмотра', uk: 'Немає історії перегляду', en: 'No history' },
      lampac_nolink: { ru: 'Ссылка не найдена', uk: 'Посилання не знайдено', en: 'Link not found' },
      lampac_balanser: { ru: 'Источник', uk: 'Джерело', en: 'Source' },
      title_online: { ru: 'Онлайн', uk: 'Онлайн', en: 'Online' },
      lampac_clear_all_marks: { ru: 'Сбросить все отметки', uk: 'Скинути всі відмітки', en: 'Clear marks' },
      lampac_clear_all_timecodes: { ru: 'Сбросить таймкоды', uk: 'Скинути таймкоди', en: 'Clear timecodes' },
      lampac_change_balanser: { ru: 'Другой источник', uk: 'Інше джерело', en: 'Change source' },
      lampac_balanser_dont_work: { ru: 'Ничего не найдено на ({balanser})', uk: 'Нічого не знайдено на ({balanser})', en: 'Empty' },
      lampac_balanser_timeout: { ru: 'Автопереключение через <span class="timeout">5</span> сек.', uk: 'Автоперемикання через <span class="timeout">5</span> сек.', en: 'Switch in <span class="timeout">5</span>' },
      lampac_does_not_answer_text: { ru: 'Источник ({balanser}) не отвечает', uk: 'Джерело ({balanser}) не відповідає', en: 'Error' }
    });
