(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.3', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = false, leftVipD = '', user_id = '', uid = 'dcbee9ef84465be64feb69380', IP = '46.62.204.196', logged = false, VAST_url = false;
...
var Modss = {
	...
	var button = "<div style='position:relative' data-subtitle='modss_v".concat(manifest.version, " (23 Balansers, 18 in VIP)' class='full-start__button selector view--modss_online'>" + ico + "<span>" + this.title + "</span></div>");
    ...
    preload: function (e) {
	  ...
	  rating_kp_imdb:function (card) {
        ...
        Pub.network.clear();
          ...
          original_title: card && (card.original_title || card.original_name) || logged,
    ...
    balansers: function() {
      var balansers = {"lumex":"Lumex","videx":"ViDEX","veoveo":"VeoVeo","filmix":"Filmix 4K","kinopub":"KinoPub 4K","iremux":"IRemux 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","mango":"ManGo 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","uaflix":"UaFlix <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\"> 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","fxpro":"FXpro 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","alloha":"Alloha 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdr":"MODS's [4K, HDR]  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","eneida":"Eneida <img style=\"width:1.3em!important;height:1em!important\" src=\"data:image/png;base64,\">  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdrezka":"HDRezka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","aniliberty":"AniLiberty  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kodik":"Kodik  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinotochka":"KinoTochka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdvb":"HDVB  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","starlight":"StarLight  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>"};
    ...
    checkQualityNotification: function (quality) {
      ...
      if (isLowQuality || this.isNewMovie) {
  ...
  function veoveo(component, _object) {
    ...
    this.searchs = function (_object, kinopoisk_id) {
      ...
      var error = component.empty.bind(component);
      if (!+object.movie.kinopoisk_id && !+object.movie.kinopoisk_ID) return error();
      var src = API + 'veoveo/sId/mds/' + (+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID ? encodeURIComponent(+object.movie.kinopoisk_id || +object.movie.kinopoisk_ID) : 'null') + '/bm9uZQ==/' + fr + '?ip=' + IP + '&title=' + encodeURIComponent(select_title);
  ...
  function component(object) {
    ...
    var isVipBal = 5;//(Lampa.Storage.get('pro_pub', false) ? 5 : 5);
  ...
  function Radio_n(object) {
	...
	function startPlugin() {
		...
		*/
		...
		manifest = {
			...
			description: 'Онлайн (23 Balansers, 18 in VIP)',
			component: 'modss_online',
	...
	full_movie_not_released: {
		...
		if (Lampa.Manifest.app_digital >= 177) {
			...
			var balansers_sync = ["lumex","videx","veoveo","filmix","kinopub","hdr","fxpro","mango","alloha","filmix","kinopub","kodik","aniliberty","eneida","uakino","uaflix","hdrezka","hdvb","iremux","kinotochka","lumex","videx","veoveo","zetflix","anilibria","hdfilmtr","bazon","cdnmovies","collaps","kinobase","hydraflix","kinokrad","kinofit","seasonvar","videodb","voidboost","starlight"];
